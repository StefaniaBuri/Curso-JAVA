...
/* 
 * 
 * Las listas son colecciones ordenadas de elementos que permiten almacenar elementos de manera secuencial. 
A diferencia de los conjuntos, las listas pueden contener elementos duplicados y mantienen el orden de inserción.
- List
    - ArrayList
    - LinkedList
    - Vector
...
public class ListDemo02 {
    ...
    public static void main(String[] args) {
        ...
        ListDemo02 demo = new ListDemo02();
