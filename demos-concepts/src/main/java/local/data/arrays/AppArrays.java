...
public class AppArrays {
    ...
    public static void main(String[] args) {
        ...
        //copyOf el hash es distinto del original
        ...
        Integer[] aIntegers = {3, 1, 7, 2};
        //Arrays.sort(aIntegers, (a,b) -> b-a); //ordenación de array de mayor a menor
        Arrays.sort(aIntegers, (a,b) -> a-b); //ordenación de array de menor a mayor
