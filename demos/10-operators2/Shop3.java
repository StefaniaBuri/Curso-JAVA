...
public class Shop3 {
    ...
    // SOLUCION 3: REFACTORIZANDO SOLUCION 2
    ...
    public static void main(String[] args) {
        ...
        String line1 = "PROMOCIÓN NO APLICABLE";
        ...
        if(total >= 1000) {
            ...
            -----------------------------------
            TOTAL                       %.2f EU
                 """.formatted(numPackTrouser, numPackShirt, numPackTotal, total, finalDiscount, totalShipping, line1, line2, promotion, totalPrice));
    }
}
